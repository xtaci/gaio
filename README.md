...
5. Application can decide when to submit read or write requests, per-connection [back-pressure](https://en.wikipedia.org/wiki/Transmission_Control_Protocol#Flow_control) can be propagated to peer to slow down sending.
6. Tiny, less than 1000 LOC, easy to debug.
7. Support for Linux, BSD.
